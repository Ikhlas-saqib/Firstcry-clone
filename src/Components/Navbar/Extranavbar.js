...
function Extranavbar(props) {
    ...
    return (
        <div style={{width:"95%"}} className="allcontainer">
            <div className='leftsidecontnav'>
                <img onClick={()=>{navigate("/")}} src="https://cdn.fcglcdn.com/brainbees/images/n/fc_logo.png"></img>
                <div style={{marginLeft:"20px"}}>  <Input ref={searchRef} variant='outline' size="sm" placeholder='Search for a Category' onChange={handlesearch}/></div>
            </div>
